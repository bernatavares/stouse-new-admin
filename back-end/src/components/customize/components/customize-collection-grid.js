        ...
        <div className="card-body">
          <div className="row">
            <div className="col-sm-12 col-md-3 col-xl-2">
              <p>
                The Collection Grid displays up to 6 collections for easy
                navigation on the home page. You can set these collections here.
                If no collections are selected, then this component will not
